...
import { NavigationItem } from "../_models/index";
...
export class NavigationService {
  ...
  private _onLoginSucess: BehaviorSubject<any>;
  ...
  constructor() {
    ...
    this._onLoginSucess = new BehaviorSubject(null);
   ...
   */
  get onLoginSucess(): Observable<any> {
    return this._onLoginSucess.asObservable();
  }
  ...
  register(key: any, navigation: any): void {
    ...
    console.log("key", key, "navigation", navigation)
   ...
   * @returns {any[]}
   */
  getFlatNavigation(navigation: any, flatNavigation: NavigationItem[] = []): any {
   ...
   * @param {any} parent
   */
  getNavigationItemParent(id: any, navigation: any[] = [], parent: any = null): any {
    if (!navigation) {
      navigation = this.getCurrentNavigation();
      parent = navigation;
    }
