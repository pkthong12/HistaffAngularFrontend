...
@Component({
  selector: "sys-settingreport",
  templateUrl: "./settingreportsys.component.html",
  styleUrls: ["./settingreportsys.component.scss"],
  providers: [ToolbarService, LinkService, ImageService],
  encapsulation: ViewEncapsulation.None,
})
export class SettingReportSysComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getTreeView() {
    this._coreService.Get("hr/FormListsys/GetList").subscribe((res: any) => {
  ...
  getById(id: number) {
    return new Promise((resolve) => {
      this._coreService
        .Get("hr/FormListsys/GetByid?id=" + id)
        .subscribe((res: any) => {
          resolve(res.data);
        });
    });
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.SAVE:
        ...
        this._coreService.Post("hr/FormListsys/Update", param).subscribe((res: any) => {
          //check error
