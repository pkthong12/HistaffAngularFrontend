...
@Component({
  selector: "cms-app-salarytypesys",
  templateUrl: "./salarytypesys.component.html",
  styleUrls: ["./salarytypesys.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class SalaryTypeSysComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/sys/configsys/salarytypesys/", paramAdd]);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/sys/configsys/salarytypesys/new"]);
        break;
      ...
      case ToolbarItem.LOCK:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          this._coreService
            .Post("hr/salarytypesys/ChangeStatus", ids)
            .subscribe((res: any) => {
