...
@Component({
  selector: "sys-salarystructure",
  templateUrl: "./salarystructuresys.component.html",
  styleUrls: ["./salarystructuresys.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class SalaryStructureSysComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate([
      "/sys/configsys/salarystructuresys/",
      paramAdd,
    ]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "hr/structuresys/GetAll",extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/sys/configsys/salarystructuresys/new"]);
        break;
