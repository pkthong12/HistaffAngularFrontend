import { Component, OnInit, ViewEncapsulation, OnDestroy, TemplateRef, ViewChild, AfterViewInit } from '@angular/core';
...
import { IFilterOperator, EnumFilterOperator, IInOperator, EnumSortDirection, ISortItem } from 'src/app/interfaces/IQueryListRequest';
...
export class InsChangeComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  */
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_INS_CHANGE_SA_BHXH_BHYT_OLD, //muc dong bhxh-bhyt cu
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_INS_CHANGE_SA_BHXH_BHYT_NEW, //muc dong bhxh-bhyt moi
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_INS_CHANGE_SA_BHTN_OLD, //muc dong bhtn cu
      field: 'salaryBhtnOld',
      type: 'string',
      pipe: EnumCoreTablePipeType.NUMBER,
      align: 'right',
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_INS_CHANGE_SA_BHTN_NEW, //muc ding bhtn moi
      field: 'salaryBhtnNew',
      type: 'string',
      pipe: EnumCoreTablePipeType.NUMBER,
      align: 'right',
