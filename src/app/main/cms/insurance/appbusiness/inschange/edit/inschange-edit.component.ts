...
export class InsChangeEditComponent
  ...
  salaryBhxhBhytOld: IFormBaseControl = {
    flexSize: 3,
    label: EnumTranslateKey.UI_COMPONENT_TITLE_INS_CHANGE_SA_BHXH_BHYT_OLD,
    field: 'salaryBhxhBhytOld',
    value: '',
  ...
  salaryBhxhBhytNew: IFormBaseControl = {
    flexSize: 3,
    label: EnumTranslateKey.UI_COMPONENT_TITLE_INS_CHANGE_SA_BHXH_BHYT_NEW,
    field: 'salaryBhxhBhytNew',
    value: '',
    controlType: EnumFormBaseContolType.CURRENCY,
    type: 'number',
    readonly: false,
  ...
  createForm() {
    this.form = this.fb.group({
      ...
      changeTypeName: [null],
      salaryBhxhBhytOld: [0, [Validators.required]],
      salaryBhxhBhytNew: [0, [Validators.required]],
      salaryBhtnOld: [0, [Validators.required]],
      salaryBhtnNew: [0, [Validators.required]],
      effectiveDate: [
        null,
    ...
    this.subscriptions.push(
      ...
      this.form.get('salaryBhxhBhytOld')?.valueChanges.pipe(debounceTime(500), distinctUntilChanged())
        .pipe(
          filter((_) => {
            const touched = this.form.get('salaryBhxhBhytOld')?.touched;
            return !!touched;
          }),
        ).subscribe((x) => {
      ...
      this.form.get('salaryBhxhBhytNew')?.valueChanges.pipe(debounceTime(500), distinctUntilChanged())
        .pipe(
          filter((_) => {
            const touched = this.form.get('salaryBhxhBhytNew')?.touched;
            return !!touched;
          }),
        ).subscribe((x) => {
      ...
      this.form.get('changeMonthString')?.valueChanges.pipe(distinctUntilChanged())
        // .pipe(
        //   filter((_) => {
        //     const touched = this.form.get('changeMonthString')?.touched;
        //     return !!touched;
        //   }),
        // )
        .subscribe((x) => {
      ...
      this.form.get('declarationPeriodString')?.valueChanges.pipe(distinctUntilChanged())
        // .pipe(
        //   filter((_) => {
        //     const touched = this.form.get('declarationPeriodString')?.touched;
        //     return !!touched;
        //   }),
        // )
        .subscribe((x) => {
      ...
      this.form.get('arrearsFromMonthString')?.valueChanges.pipe(distinctUntilChanged())
        // .pipe(
        //   filter((_) => {
        //     const touched = this.form.get('arrearsToMonthString')?.touched;
        //     return !!touched;
        //   }),
        // )
        .subscribe((x) => {
      ...
      this.form.get('withdrawalFromMonthString')?.valueChanges.pipe(distinctUntilChanged())
        // .pipe(
        //   filter((_) => {
        //     const touched = this.form.get('withdrawalFromMonthString')?.touched;
        //     return !!touched;
        //   }),
        // )
        .subscribe((x) => {
      ...
      this.form.get('withdrawalToMonthString')?.valueChanges.pipe(distinctUntilChanged())
        // .pipe(
        //   filter((_) => {
        //     const touched = this.form.get('withdrawalToMonthString')?.touched;
        //     return !!touched;
        //   }),
        // )
        .subscribe((x) => {
  ...
  disableControl(e: any) {
    ...
    if (this.listTruyThu.includes(e.code)) {
      this.form.get('salaryBhxhBhytOld')?.disable();
      this.form.get('salaryBhtnOld')?.disable();
      this.form.get('salaryBhxhBhytOld')?.setValue(0);
      ...
      this.form.get('salaryBhxhBhytOld')?.enable();
      this.form.get('salaryBhtnOld')?.enable();
      this.form.get('salaryBhxhBhytNew')?.disable();
      this.form.get('salaryBhtnNew')?.disable();
      this.form.get('salaryBhxhBhytNew')?.setValue(0);
      ...
      this.appService.post(url, mixRequest).subscribe((response) => {
        if (response.ok == true && response.status == 200) {
          ...
          if (body.statusCode === 200) {
            ...
            //   `${this.mls.trans(response.body.messageCode)}`,
            //   this.alertOptions
            // );
          ...
          .subscribe((res) => {
            if (res.ok && res.status == 200) {
              ...
              if (body.statusCode === 200) {
                ...
                //TRUY THU
                this.form
                  .get('arrearsFromMonthString')
                  ?.setValue(innerBody.aFrom);

                this.form.get('arrearsToMonthString')?.setValue(innerBody.aTo);

                this.form
                  .get('arBhxhSalaryDifference')
                  ?.setValue(innerBody.aSi);

                this.form
                  .get('arBhytSalaryDifference')
                  ?.setValue(innerBody.aHi);

                this.form
                  .get('arBhtnSalaryDifference')
                  ?.setValue(innerBody.aUi);

                this.form
                  .get('arBhtnldBnnSalaryDifference')
                  ?.setValue(innerBody.aBhtnld);

                //THOAI THU
                this.form
                  .get('withdrawalFromMonthString')
                  ?.setValue(innerBody.rFrom);

                this.form
                  .get('withdrawalToMonthString')
                  ?.setValue(innerBody.rTo);

                this.form
                  .get('wdBhxhSalaryDifference')
                  ?.setValue(innerBody.rSi);

                this.form
                  .get('wdBhytSalaryDifference')
                  ?.setValue(innerBody.rHi);

                this.form
                  .get('wdBhtnSalaryDifference')
                  ?.setValue(innerBody.rUi);

                this.form
                  .get('wdBhtnldBnnSalaryDifference')
                  ?.setValue(innerBody.rBhtnld);
              }
            }
          });
      }
