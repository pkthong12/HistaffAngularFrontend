...
export class KpiTargetComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/payroll/list/kpitarget/", paramAdd]);
  };
  ...
  getListData = (groupId: any): void => {
    ...
    this._coreService.execute(state, "kpitarget/GetAll", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/payroll/list/kpitarget/new"]);
        break;
