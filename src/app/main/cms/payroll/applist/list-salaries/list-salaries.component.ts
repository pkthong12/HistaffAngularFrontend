...
export class ListSalariesComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  */
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_PA_LISTSALARIES_IS_FORMULA, //con thuc theo bien dong
      field: 'isFormula',
      type: 'bool',
      align: 'center',
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      this.onObjectSal = this.listSalariestService.objectId === undefined ? 1519 : this.listSalariestService.objectId;
