...
@Component({
  selector: "cms-importpayroll-edit",
  templateUrl: "./importpayroll-edit.component.html",
  styleUrls: ["./importpayroll-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class ImportPayrollEditComponent implements OnInit {
  // Varriable Language
  flagState = "";
  ...
  buildToolbar = () => {
    setTimeout(() => {
      ...
      this.toolbar = this.globals.buildToolbar("importpayroll", toolbarList!);
    }, 200);
  };
