...
@Component({
  selector: "cms-importmachines-edit",
  templateUrl: "./importmachines-edit.component.html",
  styleUrls: ["./importmachines-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class ImportMachinesEditComponent implements OnInit {
  // Varriable Language
  flagState = "";
  ...
  buildToolbar = () => {
    setTimeout(() => {
      ...
      this.toolbar = this.globals.buildToolbar("importmachines", toolbarList!);
    }, 200);
  };
