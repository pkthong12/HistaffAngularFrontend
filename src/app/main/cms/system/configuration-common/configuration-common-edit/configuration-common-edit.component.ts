...
// cần sử dụng kiểu dữ liệu EnumTranslateKey
// cái EnumTranslateKey là kiểu dữ liệu enum
// enum dịch ra là "liệt kê"
import { EnumTranslateKey } from 'src/app/enum/EnumTranslateKey';

// cần sử dụng kiểu dữ liệu ICoreFormSection
// để tạo thuộc tính
// rồi dùng thuộc tính đấy để hứng dữ liệu
// hứng xong rồi thì truyền dữ liệu đấy ra giao diện
import { ICoreFormSection } from 'src/app/libraries/core-form/core-form/enum-interfaces';

// cần sử dụng kiểu liệt kê enum
// giúp liệt kê các kiểu của input
// ví dụ: liệt kê ra input kiểu textbox, kiểu checkbox,...
import { EnumFormBaseContolType } from 'src/app/libraries/core-form/core-form/enum-interfaces';

// cần sử dụng lớp Validators
// giúp xác nhận dữ liệu
import { Validators } from '@angular/forms';

// cần sử dụng kiểu dữ liệu ICorePageEditCRUD
// để khai báo thuộc tính crud
// để làm việc với API
import { ICorePageEditCRUD } from 'src/app/libraries/core-page-edit/core-page-edit.component';

// cần sử dụng kiểu liệt kê enum
// lúc này "api" được tạo ra từ kiểu enum
import { api } from 'src/app/constants/api/apiDefinitions';

// cần kế thừa lớp BaseEditComponent
import { BaseEditComponent } from 'src/app/libraries/base-edit/base-edit/base-edit.component';

// cần sử dụng kiểu dữ liệu DialogService
