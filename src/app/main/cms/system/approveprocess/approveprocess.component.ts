...
@Component({
  selector: "cms-app-approveprocess",
  templateUrl: "./approveprocess.component.html",
  styleUrls: ["./approveprocess.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class ApproveProcessComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/system/approveprocess/", paramAdd]);
  };

  // Build Toolbar
  buildToolbar = () => {
    const toolbarList = [ToolbarItem.EDIT];
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "tenant/approveprocess/getall");
  };

  public dataStateChange(state: DataStateChangeEventArgs): void {
    this.pageIndex = Math.floor(state.skip! / state.take!);
    let extraParams: any[] = [];
    this._coreService.execute(state, "tenant/approveprocess/getall", extraParams);
  }
  // Số thứ tự
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/system/approveprocess/new"]);
        break;
