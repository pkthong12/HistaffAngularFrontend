...
@Component({
  selector: 'app-hu-province',
  templateUrl: './hu-province.component.html',
  styleUrls: ['./hu-province.component.scss'],
})
export class HuProvinceComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('sticker') sticker!: TemplateRef<any>;

  /*
  Properties being passed to core-page-list
  */
  title = EnumTranslateKey.UI_COMPONENT_TITLE_HU_PROVINCE;

  apiDefinition: ICorePageListApiDefinition = {
    queryListRelativePath: api.HU_PROVINCE_QUERY_LIST,
  };
  ...
  crud: ICorePageListCRUD = {
    deleteIds: api.HU_PROVINCE_DELETE_IDS,
    toggleActiveIds: api.HU_PROVINCE_TOGGLE_ACTIVE_IDS,
  };
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_LABEL_PROVINCE_IS_ACTIVE,
      field: 'isActiveStr',
      type: 'string',
      align: 'center',
      width: 130,
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_LABEL_PROVINCE_CODE,
      field: 'code',
      type: 'string',
      align: 'left',
      width: 200,
  ...
  //       this.appService.post(api.HU_PROVINCE_SUBMIT_ACTIVE, this.selectedIds).subscribe(x => {
  ...
  //       // post cái mảng id lên server
  //       this.appService.post(api.HU_PROVINCE_SUBMIT_STOP_ACTIVE, this.selectedIds).subscribe(x => {
