...
@Component({
  selector: "cms-app-decisioncreate",
  templateUrl: "./decisioncreate.component.html",
  styleUrls: ["./decisioncreate.component.scss"],
...
export class DecisionCreateComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/profile/setting/decisioncreate/", paramAdd]);
    this.router.navigate(["/cms/profile/setting/decisioncreate/", paramAdd]);
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "hr/sysdecision/getallbydecision");
  };

  public dataStateChange(state: DataStateChangeEventArgs): void {
    this.pageIndex = Math.floor(state.skip! / state.take!);
    let extraParams: any[] = [];
    this._coreService.execute(state, "hr/sysdecision/getallbydecision", extraParams);
  }
  // Số thứ tự
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    // console.log("selectDeletes",selectDeletes)
    //console.log("selectDeletes",buttonId)
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/profile/setting/decisioncreate/new"]);
        break;
      ...
      case ToolbarItem.LOCK:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          this._coreService
            .Post("hr/sysdecision/ChangeStatus", ids)
            .subscribe((res: any) => {
