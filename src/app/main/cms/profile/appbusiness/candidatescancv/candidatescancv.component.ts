...
@Component({
  selector: "cms-profile-candidatescancv",
  templateUrl: "./candidatescancv.component.html",
  styleUrls: ["./candidatescancv.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class CandidatescancvComponent implements OnInit {
  toolItems$ = new BehaviorSubject<any[]>([
    ToolbarItem.ADD, ToolbarItem.EDIT, ToolbarItem.PRINT, ToolbarItem.EXPORT_EXCEL
  ])
  // Varriable Language
  languages: any;
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/profile/business/candidatescancv/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "hr/candidate/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/profile/business/candidatescancv/new"]);
        break;
        ...
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          if (
            ...
            this.router.navigate([
              "/cms/profile/business/candidatescancv/",
              paramAdd,
            ]);
          } else {
      ...
      case ToolbarItem.LOCK:
        if (selectDeletes && selectDeletes.length > 0) {
          let ids = selectDeletes.map((i: any) => i.id);
          this._coreService
            .Post("hr/candidatescancv/ChangeStatus", ids)
            .subscribe((res: any) => {
