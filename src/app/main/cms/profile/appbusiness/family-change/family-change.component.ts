...
export class FamilyChangeComponent implements OnInit, OnDestroy {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/profile/business/family-change/", paramAdd]);
  };
  ...
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "hr/Employee/GetAllFamilyAdd", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.APPROVED:
        this.router.navigate(["/cms/profile/business/family-change/new"]);
        break;
