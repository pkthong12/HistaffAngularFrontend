...
import { CoreAccordionService } from 'src/app/libraries/core-accordion/core-accordion/core-accordion.service';
...
export class StaffProfileEditComponent extends BaseEditComponent implements OnInit, AfterViewInit {
  ...
  learningLevelId: IFormBaseControl = {  //Trình độ học vấn
    flexSize: 6,
    value: '',
  ...
  onFormSubmit() {
    ...
    if(!!this.textValidate || !!this.textValidateTaxCode || !!this.textValidateitimeId){
      return;
    }
