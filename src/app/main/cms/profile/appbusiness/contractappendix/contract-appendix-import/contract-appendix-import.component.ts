...
@Component({
  ...
  templateUrl: "./contract-appendix-import.component.html",
  styleUrls: ["./contract-appendix-import.component.scss"],
})
export class ContractAppendixImportComponent extends BaseComponent implements OnInit {

  captionCode: EnumTranslateKey = EnumTranslateKey.UI_COMPONENT_TITLE_CONTRACT_IMPORT

  apiDefinition: ICorePageListApiDefinition = {
    queryListRelativePath: api.HU_CONTRACTAPPENDIX_QUERY_LIST_IMPORT,
  }
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_LABEL_CONTRACTAPPENDIX_CONTRACTTYPENAME,
  ...
  onCoreButtonGroupVNSClick(e: ICoreButtonVNS) {
    if (e.code === EnumCoreButtonVNSCode.NONE_HEADER_CANCEL) {
      ...
      this.subscriptions.push(
        this.appService.post(api.HU_CONTRACTAPPENDIX_SAVE_IMPORT, this.importPreviewOuterParam).subscribe(x => {
          this.loading = false;
