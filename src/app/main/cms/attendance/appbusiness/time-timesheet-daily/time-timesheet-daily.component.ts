...
export class TimeTimesheetDailyComponent extends BaseComponent implements AfterViewInit {
  ...
  */
  ...
  search(): void {
    ...
    const remainOuterInOperators = currentOuterInOperators.filter(x => !!!(x.field === "periodId" || x.field === "codeColor" || x.field === "employeeId" || x.field === "timeRegisteredStatus" || x.field === "orgId"));
