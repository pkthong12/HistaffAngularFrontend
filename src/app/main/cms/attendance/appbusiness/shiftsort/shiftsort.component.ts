...
import { BehaviorSubject, Subscription, debounceTime, distinctUntilChanged, filter, map } from "rxjs";
import { Router, ActivatedRoute } from "@angular/router";

import { ICorePageListCRUD, ICorePageListEditRouting, ICoreTableFlatColumnItem } from "src/app/libraries/core-page-list/core-page-list.component";
    ...
    if (this.salPeriod == null) {
      ...
      if (fileInput.value != '') {
        ...
        blobToBase64(blob).then((base64: any) => {
          ...
          this.http.post(api.AT_SHIFT_SORT_IMPORT_TEMP, requestBody, { responseType: 'blob' })
            .subscribe(
              (response: Blob) => {
